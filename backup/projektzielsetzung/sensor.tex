...
% PmodMaxSonar Controller Register Mapping in LaTeX with longtables
...
\begin{longtable}{|p{3cm}|p{3cm}|p{8cm}|}
    ...
    \hline
    2 & read\_valid & R & 0 & Signals if the current values in the DIST0, UCSR \& ADSR Registers are valid.
    ...
    \hline
    0 & ur\_error & R & 0 & Displays UART Framing Error (no stop bit received).\\
    \hline
