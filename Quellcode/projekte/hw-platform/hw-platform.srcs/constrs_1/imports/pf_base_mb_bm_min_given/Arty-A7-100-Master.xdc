...
create_clock -add -name sys_clock -period 10.00 -waveform {0 5} [get_ports { sys_clock }];
...
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { o_db4_7_0[0] }]; #IO_L6N_T0_VREF_15 Sch=ja[7] //db04 //nibble mode uses db04-db07
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { o_db4_7_0[1] }]; #IO_L10P_T1_AD11P_15 Sch=ja[8] //db05
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { o_db4_7_0[2] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9] //db06
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { o_db4_7_0[3] }]; #IO_25_15 Sch=ja[10] //db07
...
set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { o_register_select_0 }]; #IO_L14P_T2_SRCC_35 Sch=jd[7] //lcd_rs
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { o_read_write_0 }]; #IO_L14N_T2_SRCC_35 Sch=jd[8] //lcd_rw
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { o_read_write_enable_0 }]; #IO_L15P_T2_DQS_35 Sch=jd[9] //lcd_e
...
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { o_tx_0  }]; #IO_L18P_T2_A12_D28_14 Sch=ck_io[1] #pmodmaxsonar rx
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { i_rx_0  }]; #IO_L16P_T2_CSI_B_14 Sch=ck_io[0] #pmodmaxsonar tx
#set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { ck_io38 }]; #IO_L7N_T1_D10_14 Sch=ck_io[38]
#--
