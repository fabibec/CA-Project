...
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { o_lcd_db4_7[0] }]; #IO_L6N_T0_VREF_15 Sch=ja[7] //db04 //nibble mode uses db04-db07
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { o_lcd_db4_7[1] }]; #IO_L10P_T1_AD11P_15 Sch=ja[8] //db05
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { o_lcd_db4_7[2] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9] //db06
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { o_lcd_db4_7[3] }]; #IO_25_15 Sch=ja[10] //db07
...
set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { o_lcd_rs }]; #IO_L14P_T2_SRCC_35 Sch=jd[7] //lcd_rs
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { o_lcd_rw }]; #IO_L14N_T2_SRCC_35 Sch=jd[8] //lcd_rw
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { o_lcd_e }]; #IO_L15P_T2_DQS_35 Sch=jd[9] //lcd_e
