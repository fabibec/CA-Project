...
\begin{longtable}{|p{3cm}|p{3cm}|p{8cm}|}
    ...
    \hline
    9:2 & lcd\_state \textit{(for debugging)} & R & 0x00 & Current state of LCD controller. \\
    \hline
    10 & display\_busy & R & 0 & Indicates the display is currently processing a command. \\
    \hline
    11 & lcd\_error\_flag & R & 0 & Indicates an error occurred during last operation. \\
    \hline
    19:12 & lcd\_error\_code \textit{(optional)} & R & 0x00 & Error code. Detailed description will be provided if needed. \\
    \hline
    31:20 & reserved & & & \\
    \hline
    ...
    \hline
    15:8 & last\_ddram\_pos & R & 0xFF & Last updated DDRAM address/position for character (00H-27H for line 1, 40H-67H for line 2)  \\
    \hline
    23:6 & ddram\_pos & R/W & 0xFF & DDRAM address/position for character (00H-27H for line 1, 40H-67H for line 2) for software testing purpose (e.g. read symbol which was written before). \\
    \hline
    24 & write\_char & R/W & 0 & Write 1 to initiate character write either to specified DDRAM position (if ddram\_pos is in valid range) or default last\_ddram\_pos. \\
    \hline
    25 & read\_char & R/W & 0 & Write 1 to read character either from specified DDRAM position (if ddram\_pos is in valid range) or default last\_ddram\_pos. \\
    \hline
    31:26 & reserved & & & \\
    \hline
    ...
    \begin{longtable}{|p{1cm}|p{3cm}|p{2cm}|p{1cm}|p{6.25cm}|}
        ...
        \hline
        1 & clear\_display & R/W & 0 & Write 1 to clear the display \\
        \hline
        2 & return\_home & R/W & 0 & Write 1 to return cursor to home position \\
        \hline
        ...
        \hline
        7 & display\_line & R/W & 0 & Indicates selected line on display (0 = line 1, 1 = line 2) \\
        \hline
        31:8 & reserved & & & \\
        \hline
