...
\begin{longtable}{|p{3cm}|p{3cm}|p{8cm}|}
    ...
    \hline
    8:1 & lcd\_state \textit{(for debugging)} & R & 0x00 & Current state of LCD controller. (init: 0x01, ready: 0x02, write: 0x04, read: 0x08, clear display: 0x10, return home: 0x14, display control: 0x18, display line switch: 0x1C) \\
    \hline
    ...
    \begin{longtable}{|p{1cm}|p{3cm}|p{2cm}|p{1cm}|p{6.25cm}|}
        ...
        \hline
        4 & cursor\_apply \textit{(optional)} & R/W & 0 & Write 1 to apply cursor formatting set in cursor\_on and cursor\_blink. \\
        \hline
