...
--Command     : generate_target as_axi_verification.bd
--Design      : as_axi_verification
...
entity as_axi_verification is
  ...
  attribute CORE_GENERATION_INFO of as_axi_verification : entity is "as_axi_verification,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=as_axi_verification,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=None}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of as_axi_verification : entity is "as_axi_verification.hwdef";
end as_axi_verification;

architecture STRUCTURE of as_axi_verification is
  component as_axi_verification_axi_vip_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
  ...
  end component as_axi_verification_axi_vip_0_0;
  component as_axi_verification_as_0_0 is
  port (
    i_rx : in STD_LOGIC;
    o_tx : out STD_LOGIC;
  ...
  end component as_axi_verification_as_0_0;
  signal ACLK_1 : STD_LOGIC;
  signal ARESETN_1 : STD_LOGIC;
  signal as_0_o_interrupt : STD_LOGIC;
  ...
  attribute X_INTERFACE_PARAMETER of ACLK : signal is "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_RESET ARESETN, CLK_DOMAIN as_axi_verification_ACLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
  attribute X_INTERFACE_INFO of ARESETN : signal is "xilinx.com:signal:reset:1.0 RST.ARESETN RST";
  attribute X_INTERFACE_PARAMETER of ARESETN : signal is "XIL_INTERFACENAME RST.ARESETN, INSERT_VIP 0, POLARITY ACTIVE_LOW";
  attribute X_INTERFACE_INFO of o_interrupt_0 : signal is "xilinx.com:signal:interrupt:1.0 INTR.O_INTERRUPT_0 INTERRUPT";
  attribute X_INTERFACE_PARAMETER of o_interrupt_0 : signal is "XIL_INTERFACENAME INTR.O_INTERRUPT_0, PortWidth 1, SENSITIVITY LEVEL_HIGH";
begin
  ACLK_1 <= ACLK;
  ARESETN_1 <= ARESETN;
  i_rx_1 <= i_rx;
  o_interrupt_0 <= as_0_o_interrupt;
  o_tx <= as_0_o_tx;
as_0: component as_axi_verification_as_0_0
     port map (
      i_rx => i_rx_1,
      o_interrupt => as_0_o_interrupt,
      o_tx => as_0_o_tx,
      s00_axi_aclk => ACLK_1,
...
axi_vip_0: component as_axi_verification_axi_vip_0_0
     port map (
      aclk => ACLK_1,
      aresetn => ARESETN_1,
