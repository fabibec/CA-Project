...
HD_PWD='/1work/fpgaproc/test_mb_pmod_maxsonar/test_mb_pmod_maxsonar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mbblockdesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mbblockdesign_wrapper.tcl -notrace
