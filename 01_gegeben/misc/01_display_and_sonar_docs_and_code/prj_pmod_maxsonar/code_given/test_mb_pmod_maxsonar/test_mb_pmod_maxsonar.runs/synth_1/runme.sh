...
HD_PWD='/1work/fpgaproc/test_mb_pmod_maxsonar/test_mb_pmod_maxsonar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbblockdesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbblockdesign_wrapper.tcl
